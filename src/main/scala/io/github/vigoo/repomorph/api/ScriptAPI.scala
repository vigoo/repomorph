...
import io.github.vigoo.repomorph.actions.{ReplaceStringAction, FileAction, RemoveLinesAction}
...
object ScriptAPI {
  ...
  def replace(in: String, out: String): FileAction = new ReplaceStringAction(in, out)
